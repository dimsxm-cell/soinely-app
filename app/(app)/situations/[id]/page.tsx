  ...
  return (
    <main className="min-h-screen bg-[#F6F7F5] text-navy">
      <div className="mx-auto flex max-w-2xl flex-col gap-7 px-6 py-10 sm:py-14">
        ...
        <a
          href="tel:15"
          className="btn-glace flex items-center justify-center gap-2.5 rounded-full bg-[#c0362c] px-5 py-3.5 text-[15px] font-semibold text-white shadow-[0_8px_20px_rgba(192,54,44,0.28)]"
        >
