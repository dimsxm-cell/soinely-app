    ...
    <main className="min-h-screen bg-[#F6F7F5] text-navy">
      <FournisseurCoordonneesPraticien initiales={coordonnees}>
        <div className="mx-auto flex max-w-2xl flex-col gap-7 px-6 py-10 sm:py-14">
          ...
          {/* Sous la source (et sous la mission clinique liée, si présente),
              jamais au-dessus : ces fiches sont un contenu de référence
              partagé. Des coordonnées en tête se liraient comme une
