      ...
      <div className="mx-auto flex max-w-2xl flex-col gap-6 px-6 py-10 sm:py-14">
        ...
        >
          ...
          <button
            type="submit"
            disabled={enCours}
            className="cta-lift mt-1 rounded-full bg-gradient-to-r from-brand-violet to-purple-500 px-5 py-3.5 text-[15px] font-semibold text-white shadow-[0_8px_20px_rgba(124,58,237,0.28)] disabled:opacity-60"
          >
